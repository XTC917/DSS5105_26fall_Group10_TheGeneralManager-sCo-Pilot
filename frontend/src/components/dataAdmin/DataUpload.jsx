...
import { previewExcel, importExcel, getImportStatus } from "../../services/dataAdminApi.js";
...
export default function DataUpload() {
    ...
    children: (
      <div>
        <Steps current={uploadStates[key].currentStep} style={{ marginBottom: 30 }}>
          <Steps.Step title="Upload" description="Select file" />
          <Steps.Step title="Preview" description="Check data" />
          <Steps.Step title="Complete" description="View results" />
        </Steps>
  ...
  return (
    <div>
      <h2 className="text-base font-semibold text-ink">Data Upload</h2>
