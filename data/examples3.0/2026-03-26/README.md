...
| IN_PROGRESS / KNITTING | 3 |
| IN_PROGRESS / ORDERED | 25 |
| IN_PROGRESS / PACKING | 1 |
| IN_PROGRESS / WASHING | 4 |
...
| ORD-019 | COMPLETE | ASSEMBLY | 倒推上一站（尚未到 4/1 那一站） |
| ORD-020 | WASHING | KNITTING | 倒推上一站（尚未到 4/1 那一站） |
...
| ORD-030 | COMPLETE | WASHING | 倒推上一站（尚未到 4/1 那一站） |
...
| ORD-054 | COMPLETE | ASSEMBLY | 倒推上一站（尚未到 4/1 那一站） |
| ORD-055 | ASSEMBLY | ORDERED | 已下单未开工（4/1 的 ASSEMBLY 从 2026-04-01 才开始；L=下单日） |
| ORD-060 | COMPLETE | PACKING | 倒推上一站（尚未到 4/1 那一站） |
...
| ORD-069 | COMPLETE | ASSEMBLY | 倒推上一站（尚未到 4/1 那一站） |
...
| ORD-084 | COMPLETE | WASHING | 倒推上一站（尚未到 4/1 那一站） |
