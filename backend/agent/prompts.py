...
| "The TrendCart order" or other customer/product that may match many rows | get_order_status once; if AMBIGUOUS, ask for an order_id. Do not silently pick one |
